...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, userEmail, password, foundUser, isPasswordValid, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        _a = req.body, userEmail = _a.email, password = _a.password;
                        return [4 /*yield*/, auth_service_1.default.getUserByEmail(userEmail)];
                    case 1:
                        foundUser = _b.sent();
                        if (!foundUser) {
                            return [2 /*return*/, res.status(404).json({ message: 'User not found' })];
                        }
                        return [4 /*yield*/, auth_service_1.default.comparePasswords(password, foundUser.password)];
                    case 2:
                        isPasswordValid = _b.sent();
                        if (!isPasswordValid) {
                            return [2 /*return*/, res.status(401).json({ message: 'Invalid password' })];
                        }
                        return [4 /*yield*/, auth_service_1.default.generateToken(userEmail, password)];
                    case 3:
                        token = _b.sent();
