...
var UsersController = /** @class */ (function (_super) {
    ...
    UsersController.prototype.registration = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, password, confirmPassword, user, data, error_1;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (password !== confirmPassword) {
                            res.status(400);
                            return [2 /*return*/, res.json({ message: 'Passwords do not match' })];
                        }
                        return [4 /*yield*/, services_1.AuthService.getUserByEmail(req.body.email)];
                    case 1:
                        user = _b.sent();
                        if (user) {
                            res.status(400);
                        ...
                        return [4 /*yield*/, services_1.DatabaseService.create('user', req.body)];
                    case 2:
                        data = _b.sent();
                        res.status(201);
